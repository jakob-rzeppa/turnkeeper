...
impl Stat {
    ...
    pub fn try_new_number_stat(id: Uuid, key: String, value: i64) -> Result<Self, DomainError> {
    ...
    pub fn try_new_bool_stat(id: Uuid, key: String, value: bool) -> Result<Self, DomainError> {
