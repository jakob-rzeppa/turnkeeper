use crate::application::game::plugin::{parser::old_abstract_syntax_tree::statement::Assignment, runtime::RuntimeEnvironment};
...
#[cfg(test)]
mod tests {
    use crate::application::game::plugin::{common::Position, parser::old_abstract_syntax_tree::{expression::{Expr, ExprAtom, Literal}, identifier::Identifier}, runtime::memory::VariableValue};
