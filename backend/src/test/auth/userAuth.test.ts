    ...
    describe('authenticateUser', () => {
        ...
        describe('when the player does not exist', () => {
            it('should log an error', () => {
                (playerRepository.getPlayerById as Mock).mockReturnValueOnce(null);

                expect(authenticateUser(mockSocket, 2, 'anySecret')).toBe(false);
        ...
        describe('when the secret is invalid', () => {
            it('should log an error, emit and connection_error and call socket.disconnect', () => {
                ...
                expect(authenticateUser(mockSocket, 1, 'wrongSecret')).toBe(false);
        ...
        describe('when the player is already connected', () => {
            it('should log an error, emit and connection_error and call socket.disconnect', () => {
                ...
                expect(authenticateUser(mockSocket, 1, 'actualSecret')).toBe(false);
        ...
        describe('when the credentials are valid and a user for the player is not already connected', () => {
            it('should return true', () => {
                ...
                expect(authenticateUser(mockSocket, 1, 'actualSecret')).toBe(true);
