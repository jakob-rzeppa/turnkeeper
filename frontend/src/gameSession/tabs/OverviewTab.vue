...
<template>
    ...
    <div v-else class="p-4 space-y-6">
        ...
        <div>
            ...
            <div
                v-if="session.gameState.value && session.gameState.value.game_stats.length > 0"
                class="space-y-3"
            >
                <div class="p-3 bg-base-200 rounded flex flex-col gap-4">
                    <StatDisplay
        ...
        <div>
            ...
            <div
                v-if="session.gameState.value && session.gameState.value.players.length > 0"
                class="space-y-4"
            >
                <div
                ...
                >
                    <div class="flex items-center mb-3">
                        ...
                        <span
                            v-if="index === session.gameState.value?.current_player_index"
                    ...
                    <div
                        v-if="session.gameState.value.player_stats.length > 0"
        ...
        <div>
            ...
            <div
                v-if="
                    session.displayTemplate.value &&
                    session.displayTemplate.value.actions.length > 0
                "
                class="space-y-3 p-3 bg-base-200 rounded"
            >
                <ActionExecutor
