...
<template>
    <div v-if="!playerStore.player" class="min-h-screen flex items-center justify-center p-4">
    ...
    <div v-else class="min-h-screen p-4">
        <!-- Container with max width to maintain mobile feel -->
                ...
                <div class="card-body">
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                <div
                                    v-if="typeof stat.value === 'boolean'"
                                    class="flex items-center"
                                >
                                    <div
                                        :class="[
                                            'badge',
                                            stat.value ? 'badge-success' : 'badge-error',
                                        ]"
                                    >
                                        {{ stat.value ? 'Yes' : 'No' }}
                                    </div>
